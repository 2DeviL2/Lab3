...
&nbsp;<asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="Редактировать заказчиков" />
&nbsp;<asp:Button ID="Button8" runat="server" OnClick="Button8_Click" Text="Удалить заказчика" />
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource2">
            <Columns>
                ...
                <asp:BoundField DataField="IdCust" HeaderText="Номер заказчика" SortExpression="IdCust" ReadOnly="True" />
        ...
        &nbsp;<asp:Button ID="Button5" runat="server" Text="Удалить заказ" OnClick="Button5_Click" />
&nbsp;<asp:Panel ID="Panel1" runat="server" Visible="False">
            ...
            &nbsp;<asp:Button ID="Button3" runat="server" Text="Отменить" OnClick="Button3_Click" />
            &nbsp;</asp:Panel>
    </form>
</body>
</html>
